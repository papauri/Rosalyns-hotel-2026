...
<nav class="admin-nav">
    <ul>
        ...
        <li><a href="individual-rooms.php" class="<?php echo $current_page === 'individual-rooms.php' ? 'active' : ''; ?>"><i class="fas fa-door-open"></i> Individual Rooms</a></li>
        <?php endif; ?>
        <?php if (_canShowNavItem('room_maintenance')): ?>
        <li><a href="room-maintenance.php" class="<?php echo $current_page === 'room-maintenance.php' ? 'active' : ''; ?>"><i class="fas fa-tools"></i> Room Maintenance</a></li>
        <?php endif; ?>
        <?php if (_canShowNavItem('housekeeping')): ?>
        <li><a href="housekeeping.php" class="<?php echo $current_page === 'housekeeping.php' ? 'active' : ''; ?>"><i class="fas fa-broom"></i> Housekeeping</a></li>
        <?php endif; ?>
        ...
        <?php endif; ?>
        <?php if (_canShowNavItem('media_management')): ?>
        <li><a href="media-management.php" class="<?php echo $current_page === 'media-management.php' ? 'active' : ''; ?>"><i class="fas fa-photo-video"></i> Media Portal</a></li>
        <?php endif; ?>
        ...
        <?php endif; ?>
        <?php if (($user['role'] ?? '') === 'admin' || _canShowNavItem('api_keys')): ?>
        <li><a href="api-keys.php" class="<?php echo $current_page === 'api-keys.php' ? 'active' : ''; ?>"><i class="fas fa-key"></i> API Key Management</a></li>
        <?php endif; ?>
