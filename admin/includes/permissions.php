 ...
 * - media_management/media_create/media_edit/media_delete: Unified media portal controls
 * - user_create/user_edit/user_delete/user_permissions: Granular user-administration actions
 */
...
function getAllPermissions() {
    return [
        ...
        'room_maintenance' => [
            ...
            'description' => 'Manage room maintenance schedules and blocking windows',
            'icon' => 'fa-tools',
            'category' => 'Property',
        ...
        'housekeeping' => [
            'label' => 'Housekeeping',
            'description' => 'Manage housekeeping assignments and completion workflow',
            'icon' => 'fa-broom',
            'category' => 'Property',
        ...
        'media_management' => [
            'label' => 'Media Portal',
            'description' => 'Access the centralized hotel media portal',
            'icon' => 'fa-photo-video',
            'category' => 'Property',
        ...
        'media_create' => [
            'label' => 'Create Media',
            'description' => 'Create media catalog items via upload or URL',
            'icon' => 'fa-upload',
            'category' => 'Property',
            'page' => 'media-management.php'
        ],
        'media_edit' => [
            'label' => 'Edit Media',
            'description' => 'Update media source, metadata, ordering and visibility',
            'icon' => 'fa-edit',
            'category' => 'Property',
            'page' => 'media-management.php'
        ],
        'media_delete' => [
            'label' => 'Delete Media',
            'description' => 'Delete media catalog items',
            'icon' => 'fa-trash-alt',
            'category' => 'Property',
            'page' => 'media-management.php'
        ],
        ...
        'user_permissions' => [
            ...
            'description' => 'Grant/revoke granular permissions for users',
            'icon' => 'fa-shield-alt',
            'category' => 'Settings',
            'page' => 'user-management.php'
        ]
...
function getDefaultPermissionsForRole($role) {
    ...
    switch ($role) {
        ...
        case 'manager':
            return array_diff($all_permissions, [
                'user_management', 'user_create', 'user_edit', 'user_delete', 'user_permissions',
                'cache', 'section_headers', 'pages', 'media_delete'
            ]);
            
        case 'receptionist':
            return ['dashboard', 'bookings', 'calendar', 'blocked_dates', 'rooms', 'room_maintenance', 'housekeeping', 'reviews', 'gym'];
