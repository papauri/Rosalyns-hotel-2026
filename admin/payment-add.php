            ...
            if ($editId) {
                ...
                $stmt = $pdo->prepare(" 
                    INSERT INTO payments (
                        ...
                        payment_method, payment_status, {$paymentTransactionColumn},
...
function updateRoomBookingPayments($pdo, $bookingId) {
    ...
    $paidStmt = $pdo->prepare(" 
        SELECT 
            SUM(CASE WHEN payment_status IN ('completed', 'paid') THEN total_amount ELSE 0 END) as paid,
            SUM(CASE WHEN payment_status IN ('completed', 'paid') THEN vat_amount ELSE 0 END) as vat_paid
        FROM payments
