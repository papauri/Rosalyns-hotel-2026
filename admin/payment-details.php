        ...
        <div class="page-header">
            ...
            <div class="action-buttons">
                ...
                <?php if (!empty($payment['customer_phone'])): ?>
                    ...
                    <?php if ($waPhone !== ''): ?>
                        <a href="https://wa.me/<?php echo htmlspecialchars($waPhone); ?>?text=<?php echo urlencode('Hello, this is ' . $site_name . ' accounts. Payment reference: ' . ($payment['payment_reference'] ?? '')); ?>" target="_blank" rel="noopener" class="btn-secondary">
                            <i class="fab fa-whatsapp"></i> WhatsApp
                        </a>
                    <?php endif; ?>
                <?php endif; ?>
                <a href="invoices.php?search=<?php echo urlencode($payment['payment_reference']); ?>" class="btn-secondary">
