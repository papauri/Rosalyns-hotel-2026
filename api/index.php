...
class ApiAuth {
     ...
     */
    private function getRateLimit($apiKeyId) {
        try {
     ...
     */
    private function checkRateLimitStrict($apiKeyId, $rateLimit) {
        try {
    ...
    /**
     * Check rate limit (legacy method - allows exceeding by 1)
     * @deprecated Use checkRateLimitStrict for new implementations
     */
