 ...
 * Log email activity
 */
function logEmail($to, $toName, $subject, $status, $error = '', $meta = '') {
    $logDir = __DIR__ . '/../logs';
 ...
 */
function buildBookingEmailVariables($booking, $room = null, $extra = []) {
 ...
 */
function renderBookingEmailTemplate($templateKey, $vars) {
